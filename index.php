...
<body>
  ...
  <section style="height: 60vh;background: linear-gradient(rgba(0,0,0,0.5),#6E85B2),url(photo/etudiants.jpg);
    background-size: cover;
    background-position: center"  id="accueil acc">
    <div class="navbar">
    ...
    font-family: 'Kaushan Script', cursive;margin-top: -5%
    "> COLEARNIO, APPRENDRE ENSEMBLE.</h1>
        <div class="btn">
